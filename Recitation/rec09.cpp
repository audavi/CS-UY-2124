...
#include <iostream>
using namespace std;
//abstract classes prevents us from creating an object of that type
// with a pure virtual method, anything derived from the abstract class must override the pure virtual method
// that way, we can now create objects
...
void displayNumberOfPages(const PrintedMaterial& mat) {
     mat.displayNumPages();
}
// tester/modeler code
int main() {
